...
const trekImages = [
  ...
  "https://tse4.mm.bing.net/th/id/OIP.9czcC4ZTm4KXiAqWlBLXVwHaE8?cb=12&pid=Api",
  "https://tse3.mm.bing.net/th/id/OIP.aOqil48NFKuKOjfzBRyJ8gHaE8?cb=12&pid=Api",
  "https://tse1.mm.bing.net/th/id/OIP.0I3itNhXGU5fCMmXqKsFhwHaF6?cb=12&pid=Api",
];
  ...
  const itinerary = [
    {
      ...
      desc: "Day 1: Arrival in Kumaon, meet your trek leader, and enjoy an evening acclimatization walk through the local trails.",
      icon: "walk-outline",
    },
    {
      title: "Trek to Base Camp",
      desc: "Day 2: Begin your ascent to the base camp surrounded by pine forests and snow-capped peaks. Evening briefing and campfire.",
      icon: "trail-sign-outline",
    },
    {
      title: "Valley Exploration",
      desc: "Day 3: Explore the Kumaon Valley, visit hidden waterfalls, and interact with local villagers to experience authentic Himalayan culture.",
      icon: "leaf-outline",
    },
    {
      title: "Summit Push",
      desc: "Day 4: Early morning summit attempt with breathtaking sunrise views over Nanda Devi and Panchachuli peaks. Packed breakfast at the ridge.",
      icon: "sunny-outline",
    },
    {
      title: "Return to Base",
      desc: "Day 5: Descend through alpine meadows and rhododendron forests, reaching the base camp by afternoon for rest and storytelling around the bonfire.",
      icon: "arrow-down-outline",
    },
    {
      title: "Village Homestay Experience",
      desc: "Day 6: Visit a traditional Kumaoni village, learn about local crafts and cuisine, and spend the night in a cozy homestay.",
      icon: "home-outline",
    },
    {
      title: "Departure",
      desc: "Day 7: Morning reflection session followed by breakfast. Depart with unforgettable memories of the Devbhoomi trek.",
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View
        style={[
          ...
          { paddingBottom: insets.bottom + 20, marginBottom: 60 },
        ]}
      >
        <TouchableOpacity
          activeOpacity={0.9}
          style={styles.bottomButton}
          onPress={() => router.push("/(trek)/details/pick-vendors")}
        >
