...
const COLORS = {
  ...
  lightText: "#FFFFFF",
  cardBorder: "#EDEDED",
  successBg: "rgba(0, 124, 145, 0.15)", // Light cyan
};
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          <Text style={styles.subtitle}>
            Your Maruti Suzuki Dzire is all set. We've
        ...
        >
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>Maruti Suzuki Dzire</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Pickup</Text>
            <Text style={styles.detailValue}>ISBT, Dehradun</Text>
          </View>
          <View style={styles.detailRow}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.totalValue}>₹9,550</Text>
          </View>
        </MotiView>
        ...
        >
          <TouchableOpacity
            ...
            activeOpacity={0.9}
            onPress={() => router.replace("/(cars)/explore/index")}
          >
            <Text style={styles.primaryButtonText}>Rent Another Car</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.secondaryButton}
            activeOpacity={0.8}
            onPress={() => router.replace("/(cars)/bookings")}
          >
