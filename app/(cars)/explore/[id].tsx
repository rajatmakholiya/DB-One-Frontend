...
const mockCar = {
  ...
  reviewCount: 102,
  description:
    "The perfect family sedan for a comfortable trip to the mountains. This car is well-maintained, has a driver-assist system, and comes with all-India tourist permits. Enjoy a smooth and safe ride.",
  specs: [
    { icon: "car-outline", label: "Sedan" },
    { icon: "people-outline", label: "5 Seats" },
    { icon: "snow-outline", label: "AC" },
    { icon: "hardware-chip-outline", label: "Manual" },
    { icon: "color-fill-outline", label: "22 km/l" },
  ],
  provider: {
    name: "Doon Car Rentals",
...
const reviews = [
  {
    ...
    time: "1 week ago",
    comment:
      "Very clean car and the provider was extremely professional. Handover was smooth. Will definitely rent again for our next trip.",
...
export default function CarDetailScreen() {
  ...
  const car = mockCar; // Use mock data
  const tabs = useMemo(() => ["Details", "Specs", "Reviews"], []);

  const summaryStats = [
    { label: "Rating", value: `${car.rating} (${car.reviewCount})` },
    { label: "Provider", value: car.provider.name },
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        {activeTab === "Details" && (
          ...
          >
            <Text style={styles.sectionHeading}>About this car</Text>
            <Text style={styles.description}>{car.description}</Text>

            <Text style={styles.sectionHeading}>Rental Provider</Text>
            <View style={styles.hostCard}>
              <Image
                source={{ uri: car.provider.avatarUrl }}
                style={styles.avatar}
              />
              <View>
                <Text style={styles.hostName}>{car.provider.name}</Text>
                <Text style={styles.hostBio}>
                  Verified Partner since 2019
                </Text>
              </View>
            </View>
            ...
            <View style={styles.mapCard}>
              <MapView
                ...
                pointerEvents="none"
              >
                <Marker coordinate={car.coordinates} title={car.title} />
              </MapView>
            </View>
          </MotiView>
        )}
      ...
      >
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/(cars)/explore/booking")}
        >
